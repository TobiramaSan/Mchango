          ...
          <div className="inner-texts">
            <div className="main-inner-text">
              ...
              <div className="message">
                ...
                <div className="message-content">
                  <p>
                    Good morning, Wealth Builders! Just a quick update: I've hit
                    40% of my savings goal for a new investment opportunity.
                  </p>
                </div>
              </div>
            </div>
            <div className="main-inner-text">
              ...
              <div className="message">
                ...
                <div className="message-content">
                  <p>
                    Your progress is inspiring. I'm at 25% of my goal for a down
            ...
            <div className="main-inner-text">
              ...
              <div className="message">
                ...
                <div className="message-content">
                  <p>
                    Hi all, joining in! I just started, but I'm excited. My goal
                    is to save for further education.
                  </p>
                </div>
              </div>
            </div>
