...
const Landing = () => {
	...
	const { userAdd, setUserAdd } = useAccount();
			...
			<div className='landing_pg__cont'>
				...
				<div className='landing_pg__text'>
					<div className='main__text'>
						...
						<p>
							Join a host of forward-thinking group and start on a path of mutual financial progress. Create or
							join groups with ease, establish contribution objectives, and watch your money grow using smart
							contracts.
							<br /> <br />
							<span className='sm'>Initiate saving, active participation, and fostering growth.</span>
						</p>
					</div>
                  ...
                  "Connect Wallet"
								...
								{isConnected ? (
									<>
										{userAdd.substring(0, 6)}...
										{userAdd.substring(userAdd.length - 6)}
									</>
								) : (
									'Connect Wallet'
								)}
